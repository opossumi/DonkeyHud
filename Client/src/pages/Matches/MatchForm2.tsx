...
import {  Box, FormControl,  InputLabel,  MenuItem,  Select,  Typography, Paper, Dialog, DialogActions, DialogContent, DialogTitle} from '@mui/material';
...
interface MatchFormProps {
  ...
  */
  ...
  export const MatchForm2 = ({teams, match, createMatch, updateMatch, onCancel, open, setOpen, isEditing}: MatchFormProps) => {
    ...
    return (
      <Dialog onClose={handleCancel} open={open} maxWidth="lg" fullWidth color='background.paper'>
