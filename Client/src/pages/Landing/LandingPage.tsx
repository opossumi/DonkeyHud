    ...
    >
      {location.pathname === "/" && (
        <>
          ...
          <Box className="absolute left-1/2 top-1/2 flex h-screen w-full -translate-x-1/2 -translate-y-1/2 flex-col items-center justify-center rounded bg-background/95 p-4 shadow lg:h-min lg:w-min">
            <img className="w-72" src={Logo} alt="Logo" />
            <Box className="flex flex-col items-center justify-center gap-4 md:flex-row">
              <NavLink
                to="/admin/matches"
