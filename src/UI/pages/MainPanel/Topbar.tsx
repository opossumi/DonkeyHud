...
export const Topbar = ({ toggleDrawer }: TopbarProps) => {
  return (
    <div
      id="TopBar"
      className="z-[1]  border-b border-border bg-background2 p-4 lg:bg-background flex justify-between items-center flex-1"
    >
      <div className="flex lg:hidden items-center w-full gap-2">
        <button
      ...
      <div className="flex h-full items-center gap-4 w-full max-w-96">
        <button
          ...
          className="text-primary-light transition-colors hover:text-primary-dark noDrag hidden lg:block"
          rel="noreferrer"
        >
      ...
      <div className="inline-flex lg:ml-4 gap-4 w-full justify-end">
        <button
          id="minimize"
          onClick={() => window.electron.sendFrameAction("MINIMIZE")}
          className="flex justify-center items-center noDrag hover:text-primary transition-colors hover:bg-border size-7 rounded"
        >
